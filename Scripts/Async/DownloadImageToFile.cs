...
public class DownloadImageToFile : MonoBehaviour
{
    ...
    {        
        ...
        else
        {
            ...
            StartCoroutine(GetDrivePNG(cloudImages.Sky, "sky horario" + CloudImages.skyFormat));
    ...
    {        
        bool isSky = File.Exists(routeLocal + "/sky horario" + CloudImages.skyFormat);
        //textConvenient.text = routeLocal + " is " + isSky.ToString();
        if (isSky) localImages.Sky = routeLocal + "/sky horario" + CloudImages.skyFormat;
...
public class CloudImages
{
    ...
    public const string skyFormat = ".png";
